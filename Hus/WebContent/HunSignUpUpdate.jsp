...
<div id = "contentLayout">
		<form action="SignUpUpdate" name="formupdate" id="formupdate" method="post"><br>
			<fieldset>
				<div id="headername"><b>회원정보 수정</b></div>
				<div>
					<hr>
				</div>
					<table>
					<tr>
						<td class ="ExText"><input type="text" placeholder="아이디" name="Mbid" id="SignUpID" maxlength="25" size="25" readonly="readonly" value="${sessionScope.loginUser.shopid}">
						</td>
					</tr><tr>
						<td class ="ExText"><input type="password" placeholder="비밀번호" name="Mbpw" id="SUPw" maxlength="40" size="40" value="${sessionScope.loginUser.shoppw}">
						...
						<td class ="ExText"><input type="text" placeholder="이름" name="Mbname" id="SUName" maxlength="40" size="40" value="${sessionScope.loginUser.shopname}">
						<br><span class="span_ck" id="span_name">이름을 입력해주세요.</span>
						</td>
					</tr><tr>
						<td class ="ExText">
								<input type="text" id="sample6_postcode" placeholder="우편번호" name="Mbzipcode" class="zipaddr" maxlength="20" size="20" readonly="readonly" value="${sessionScope.loginUser.shopzipcode}">
								<input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" class="zipbtn" id="zipbtn">
								<br><br><input type="text" id="sample6_address" placeholder="주소" name="Mbadd1"  maxlength="40" size="40" class="zipaddr" readonly="readonly" value="${sessionScope.loginUser.shopadd1}">
								<br><br><input type="text" id="sample6_address2" placeholder="상세주소"  name="Mbadd2"  maxlength="40" size="40" class="zipaddr" value="${sessionScope.loginUser.shopadd2}">
						...
						<td class ="ExText"><input type="text" placeholder="이메일" name="Mbmail" id="SUEmail" maxlength="40" size="40" value="${sessionScope.loginUser.shopmail}">
						<br><span class="span_ck" id="span_mail">메일을 입력해주세요.</span>
						</td>
					</tr><tr>
						<td class ="ExText"><input type="text" placeholder="연락처" name="Mbphone" id="SUPhone" maxlength="40" size="40" value="${sessionScope.loginUser.shopphone}">
				...
				<div id="savres">
					<a href="#" class="srbtu btn13" type="submit">회원수정</a>
