...
/**
 * Servlet implementation class dwsupdate
 */
@WebServlet("/DwsUpdate")
public class DwsUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		writer.println(
				...
				if (result > 0) {
					writer.println("<div class='msg' >변경이 되었습니다.</div><br><br>");
				} else {
					writer.println("<div class='msg'>변경이 실패되었습니다.</div><br><br>");
				}
